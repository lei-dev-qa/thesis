...
<div class="modal fade" id="reassessmentScheduleModal{{ $app->id }}" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <h6 class="mb-0">
                                                ...
                                                <span class="text-muted">({{ \Carbon\Carbon::parse($app->assessmentBatch->intensive_review_day1)->format('l') }})</span>
                                            </h6>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <h6 class="mb-0">
                                                ...
                                                <span class="text-muted">({{ \Carbon\Carbon::parse($app->assessmentBatch->intensive_review_day2)->format('l') }})</span>
                                            </h6>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="text-muted small">Time</label>
